...
class UnifiedDiffView(
    ...
    private fun onAddGutterIconClicked(renderer: AddGutterIconRenderer, e: AnActionEvent?) {
        println("onAddGutterIconClicked visibleLine: ${renderer.visibleLine}, old: ${myLeftLineNumberConverter.execute(renderer.visibleLine)}, new: ${myRightLineNumberConverter.execute(renderer.visibleLine)}")
    }
